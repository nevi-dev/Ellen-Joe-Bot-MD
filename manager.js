...
export const SESSION_ROOT = path.resolve(__dirname, 'sessions');
export const MAIN_BOT_SESSION_DIR = path.join(SESSION_ROOT, 'main_bot');
export const SUB_BOTS_SESSION_ROOT = path.join(SESSION_ROOT, 'subs');
