...
export function makeWASocket(connectionOptions, options = {}) {
    ...
    if (nativeSendMessage) {
        conn.sendMessage = (jid, content = {}, options = {}) => nativeSendMessage(jid, withBailsAiTag(jid, content), options)
    }
    if (nativeRelayMessage && nativeSendMessage) {
        conn.relayMessage = async (jid, message = {}, options = {}) => {
            ...
            if (message?.extendedTextMessage && Object.keys(message).length === 1) {
...
reply: {
            ...
            async value(jid, text = '', quoted, options = {}) {
                ...
                const sent = await conn.sendMessage(jid, { ...options, text }, { quoted, ...options })
