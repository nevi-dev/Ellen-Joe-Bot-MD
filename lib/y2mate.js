...
// **********************************************
// CAMBIO CLAVE: Nueva URL proporcionada por el usuario
const Y2MATE_URL = 'https://y2meta.mobi/en178' 

/**
 * Función para realizar la solicitud POST con los headers necesarios
 * (Mantiene User-Agent y Referer para simular un navegador y evitar bloqueos)
 */
function post(url, formdata) {
    return fetch(url, {
        ...
        headers: {
            ...
            // Mantiene User-Agent para simular el tipo de navegador
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Safari/537.36', 
            
            // Mantiene Referer para simular que la solicitud viene de la página web
            'Referer': Y2MATE_URL
        },
