...
// **********************************************
// CAMBIO 1: Se actualiza la URL base al nuevo dominio y ruta
const Y2MATE_URL = 'https://es.y2mate.tube/m9c' 

/**
 * Función para realizar la solicitud POST con los headers necesarios
 * (CORREGIDA: Se incluye User-Agent para simular un navegador real y evitar bloqueos)
 */
function post(url, formdata) {
    return fetch(url, {
        ...
        headers: {
            ...
            // CAMBIO 2: Se agrega el User-Agent
