...
// ====================================================================
// El bot asume que está sirviendo a la red 'ellen'

// Endpoints para Códigos de Verificación
const CODES_API_ENDPOINT = 'https://report-bots-causas.duckdns.org/api/verification/codes/pending/ellen'; 
const CODES_NOTIFICATION_BASE_URL = 'https://report-bots-causas.duckdns.org/api/verification/codes/mandado/ellen'; 

// Endpoints para Mensajes del Bot (Actualizaciones de Reportes)
const MESSAGES_API_ENDPOINT = 'https://report-bots-causas.duckdns.org/api/verification/messages/pending/ellen';
const MESSAGES_NOTIFICATION_BASE_URL = 'https://report-bots-causas.duckdns.org/api/verification/messages/mandado/ellen';

const TARGET_NETWORK = 'ELLEN'; 
    ...
    try {
        ...
        if (sentCodeIds.length > 0) {
            ...
            try {
                ...
                // 🛑 CORRECCIÓN CLAVE: Si la API responde con un error HTTP (no es 'ok'), forzamos el fallo
                ...
                // Operación silenciosa. Dado que falló, el servidor central NO eliminó la tarea y se reintentará en el siguiente ciclo.
            }
        }
