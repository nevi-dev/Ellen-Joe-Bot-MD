...
const CODES_API_ENDPOINT = 'http://report-bots-causas.duckdns.org:3000/api/verification/codes/pending/ellen'; 
const CODES_NOTIFICATION_BASE_URL = 'http://report-bots-causas.duckdns.org:3000/api/verification/codes/mandado/ellen'; 

// Endpoints para Mensajes del Bot (Actualizaciones de Reportes)
const MESSAGES_API_ENDPOINT = 'http://report-bots-causas.duckdns.org:3000/api/verification/messages/pending/ellen';
const MESSAGES_NOTIFICATION_BASE_URL = 'http://report-bots-causas.duckdns.org:3000/api/verification/messages/mandado/ellen';
