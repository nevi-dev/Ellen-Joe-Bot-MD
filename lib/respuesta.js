...
const channelUrl = "https://whatsapp.com/channel/0029VbAuMiNCBtxOKcBfw71x";
...
const handler = async (type, conn, m, comando) => {
    ...
    try {
        ...
        const msgText = frasesEllen[type] || `『🦈』Acceso denegado.`;

        // Generamos contenido para obtener metadatos de alta resolución
        ...
        const content = {
            extendedTextMessage: {
                text: msgText, 
                matchedText: channelUrl, // El link del canal es el que "valida" la imagen
                description: "˚🄴🄻🄻🄴🄽-🄹🄾🄴-🄱🄾🅃",
