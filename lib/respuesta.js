...
const handler = async (type, conn, m, comando) => {
    ...
    try {
        ...
        // 1. OBTENEMOS MEDIDAS REALES PARA EVITAR EL RECORTE
        ...
        if (msgText) {
            // 2. SIMULACIÓN DE URL REAL (TÉCNICA DE BYPASS)
            await conn.sendMessage(m.chat, {
                ...
                contextInfo: {
                    ...
                    externalAdReply: {
                        ...
                        body: "˚🄴🄻🄼🄴🄽-🄹🄾🄴-🄱🄾🅃",
                        mediaType: 1,
                        // AQUÍ ESTÁ EL TRUCO: Pasamos el buffer pero inyectamos dimensiones manuales
                        thumbnail: resBuffer, 
                        renderLargerThumbnail: true,
                        // Usamos una URL que WhatsApp considere "segura" o la de tu repo
                        sourceUrl: imgUrl, 
                        mediaUrl: imgUrl,
                        // Inyectamos las medidas para que no se vea cortada (como en tu foto 2)
