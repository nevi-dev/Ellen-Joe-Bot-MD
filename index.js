...
import { purgeLegacyFiles, useSQLiteAuthState } from './core/auth.js'
import { createMessageQueue } from './core/messageQueue.js'
import { MAIN_BOT_SESSION_DIR, SUB_BOTS_SESSION_ROOT, startSubBot } from './core/manager.js'
...
const mainAuthDbPath = path.join(MAIN_BOT_SESSION_DIR, 'auth.db')
const mainAuthDbExists = fs.existsSync(mainAuthDbPath)
...
if (!methodCodeQR && !methodCode && !mainAuthDbExists) {
do {
...
}} while (opcion !== '1' && opcion !== '2' || mainAuthDbExists)
}
